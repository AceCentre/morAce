...
deviceBleName2 = device_ble_name2
...
lastMouseMovTicks = 0
lastBeepTicks = 0
lastUserBtnCheckTicks = 0
lastScKeyCheckTicks = 0

flag_blinkOnOff = 0

lastRepeatCmdSentTicks = 0
...
def setNeopixelIndication(index):
    if index == 0:
